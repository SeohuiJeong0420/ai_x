...
CREATE TABLE BOOK(
    ...
    PRICE NUMBER(8,2), --PRICE필드의 타입은 숫자전체 8자리 중 소숫점 2자리
...
SELECT * FROM EMP;
ROLLBACK; --DML취소 트랜젝션 명령어

SELECT * FROM DEPT01;
--EMP테이블과 유사한 EMP01 테이블 : EMPNO(수4-PK), ENAME(문10), SAL(수-7,2), DEPTNO(수2-FK)
...
INSERT INTO DEPT01(DEPTNO, ENAME, LOC) VALUES (20, '전산', '신림');
INSERT INTO DEPT01(DNAME, LOC, DEPTNO) VALUES('영업', '봉천', 30);
INSERT INTO DEPT01(DEPTNO, DNAME, LOC) VALUES (40, '연구', NULL);  --명시적으로 NULL입력
INSERT INTO DEPT01(DEPTNO, DNAME) VALUES (50, '설계');  --LOC : 묵시적으로 NULL입력
...
INSERT INTO SAM01 VALUES (1040, 'CAT', NULL, 10000);
...
SELECT * FROM EMP01;
    ...
    UPDATE EMP01 
        ...
        HIREDATE = SYSDATE,
        MGR = (SELECT EMPNO FROM EMP01 WHERE ENAE='KING')
        WHERE ENAME='SCOTT';
...
SELECT ID, NAME, USERID, TO_CHAR(SALARY, '99,999') FROM MY_DATA;
--4. 트랜젝션 작업 반영
COMMIT;
--5 ID가 3인 사람 수정
...
INSERT INTO EMP1(EMPNO, ENAME, JOB) VALUES(1000, 'HONGGILDONG', 'MANAGER');--오류 : 길이
INSERT INTO EMP1 (EMPNO, ENAME, JOB)VALUES(1001, 'HONG', 'MANAGER');
SELECT * FROM EMP1;
INSERT INTO EMP1(EMPNO, ENAME, JOB, SAL) VALUES (1002, 'KIN', 'MANAGER', 0);--오류 : CHECK
INSERT INTO EMP1(EMPNO, ENAME, JOB, SAL) VALUES (1002, 'KIN', 'MANAGER', 1);
SELECT * FROM EMP1;

CREATE TABLE MAJOR(
    mCODE NUMBER(1) NOT NULL PRIMARY KEY,
    mNAME VARCHAR2(5) NOT NULL,
    mOFFICE VARCHAR2(5)
);
DROP TABLE MAJOR;
DROP TABLE STUDENT;
