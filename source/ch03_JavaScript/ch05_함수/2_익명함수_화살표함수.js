...
funVar();
funVar = ()=>{
    console.log('2. 매개변수 없는화살표 함수 호출');
}
funVar();
funVar = function(i){
    console.log('3. 매개변수가 하나 있는 일반함수')
    console.log('매개변수 값 =',i);
}
funVar(10);
funVar = i =>{
    console.log('4. 매개변수가 하나 있는 화살표함수')
    console.log('매개변수 값=',i)
}
funVar(10);
funVar = function(i){
    console.log('5. 매개변수가 하나의 한줄짜리 일반함수 호출',i);
}
funVar(20);
...
funVar = x => x*x;
console.log('8. return문 만 있는 화살표함수 호출', funVar(10));
funVar =function(x,y){
    return x*10+y;
}
funVar =(x,y)=>x*10+y
...
arr.forEach(funVar=(data, idx)=>console.log(idx, '번째:', data));
